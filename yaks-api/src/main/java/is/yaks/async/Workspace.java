...
public interface Workspace {
	 ...
	 * then there are at least **quorum** independent copies of this element
	 * stored in YAKS.
	 * Of these **quorum** independent copies,
	 ...
	 * 
	 * If several evaluation function are registered with the same path
